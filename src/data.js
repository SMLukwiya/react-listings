export const houses = [
  {
    id: 1,
    image: require('./assets/sample_house/apartment1.jpg'),
    rate: '750,000',
    title: 'Brand New 1.5 Bedroom Apartment with Outdoor Space',
  ...
  {
    id: 2,
    image: require('./assets/sample_house/apartment2.jpg'),
    rate: '980,000',
    title: 'Brand New 1.8 Bedroom Apartment with Town View',
    date: (new Date()).toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' }),
    location: 'Martin Road,Najjera',
    size: '750 sq ft',
  ...
  {
    id: 3,
    image: require('./assets/sample_house/apartment3.jpg'),
    rate: '800,000',
    title: 'Brand New 1.8 Bedroom Apartment with Town View',
    date: (new Date()).toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' }),
    location: 'Martin Road,Najjera',
  ...
  {
    id: 4,
    image: require('./assets/sample_house/apartment4.jpg'),
    rate: '980,000',
    title: 'Brand New 1.8 Bedroom Apartment with Town View',
    date: (new Date()).toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' }),
    location: 'Martin Road,Najjera',
...
export const categories = [
  {
    ...
    list: [
      {
        name: 'Art Studio for rent',
        total: 6
      },
      {
        name: 'Art studio for Share',
        total: 3
      },
      {
        name: 'Art Studio for  Sublet',
        total: 5
      },
      {
        name: 'Office/Desk/Co-working Space',
        total: 31
      },
      {
        name: 'Hourly Work Space',
        total: 15
      },
      {
